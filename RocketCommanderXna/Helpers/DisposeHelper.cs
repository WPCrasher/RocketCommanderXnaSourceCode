#if TST_DISABLED
// Project: RocketCommanderXna, File: DisposeHelper.cs
// Namespace: RocketCommanderXna.Helpers, Class: DisposeHelper
// Path: C:\code\RocketCommanderXna\Helpers, Author: Abi
...
using RocketCommanderXna.Landscapes;
using RocketCommanderXna.Shaders;
using RocketCommanderXna.Tracks;
...
namespace RocketCommanderXna.Helpers
{
	...
	class DisposeHelper
	{
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref RocketCommanderXna.Graphics.Texture someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
		...
		/// </summary>
		/// <param name="someObject">Some object</param>
		public static void Dispose(ref RocketCommanderXna.Graphics.TextureFont someObject)
		{
			if (someObject != null)
				someObject.Dispose();
			someObject = null;
