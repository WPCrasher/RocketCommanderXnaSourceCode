// Project: RocketCommanderXna, File: FileHelper.cs
// Namespace: RocketCommanderXna.Helpers, Class: FileHelper
...
namespace RocketCommanderXna.Helpers
{
	...
	public class FileHelper
	{
			...
			string filename, FileMode mode, FileAccess access)
		{
			...
			StorageContainer container = XnaUserDevice.OpenContainer("RocketCommanderXna");
