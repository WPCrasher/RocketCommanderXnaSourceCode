// Project: RocketCommanderXna, File: Log.cs
// Namespace: RocketCommanderXna.Helpers, Class: Log
	...
	public class Log
	{
		...
		static Log()
		{
			try
			{
				// Open file
				FileStream file =
					FileHelper.CreateGameContentFile(LogFilename, false);
				//old: new FileStream(
				...
				writer.WriteLine("/// RocketCommanderXna");
				writer.WriteLine("");
			} // try
			catch
			{
