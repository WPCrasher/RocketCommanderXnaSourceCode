// Project: RocketCommanderXna, File: BaseGame.cs
// Namespace: RocketCommanderXna.Game, Class: BaseGame
...
namespace RocketCommanderXna.Game
{
	...
	public class BaseGame : Microsoft.Xna.Framework.Game
	{
		...
		/// </summary>
		public const float FieldOfView = (float)Math.PI / 1.8f,//1.75f,//2.0f,
			NearPlane = GameAsteroidManager.MinViewDepth,//0.5f,
			FarPlane = GameAsteroidManager.MaxViewDepth;//1000.0f;
		#endregion
		...
		/// </summary>
		public static SpaceCamera camera = null;
		...
		/// Lens flare
		/// </summary>
		protected LensFlare lensFlare = null;

		/// <summary>
		/// Parallax shader
		/// </summary>
		public static ParallaxShader ParallaxShader = null;
		...
		/// <summary>
		/// Light direction, used for ParallaxShader
		/// </summary>
